...
import ru.skillbox.diplom.group25.microservice.dialog.dialogs.CreateDialogDto;
...
@Schema(description = "Ответ на запрос создания диалога")
public class CreateDialogRs {
